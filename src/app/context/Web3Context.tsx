...
import {
  ...
  getDefaultConfig,
  darkTheme,
} from "@rainbow-me/rainbowkit"; // 导入RainbowKit相关组件
import {
  useAccount,
  useChainId,
  useConnect,
...
if (!projectId) {
  throw new Error(
    "NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID is not set in environment variables. Please add it to your .env.local file.",
  );
}
